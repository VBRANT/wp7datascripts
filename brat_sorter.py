...
if __name__ == '__main__':
    ...
    # entity_list = sort_entities('bca_03_aves_v1/bca_03_aves_v1_p053.ann')
    # print(repr(entity_list)) # see what is returned
    # write_entities(entity_list, 'bca_03_aves_v1/bca_03_aves_v1_p053_sorted.ann')

    # for a complete directory
    import os
    directory = 'bca_03_aves_v1'
    ann_files = [entry for entry in os.listdir(directory) if entry.endswith('ann')]
